...
<section class="ftco-section contact-section">
    <div class="container bg-light">
        ...
        <div class="row d-flex mb-5 bg-light d-block d-sm-none">
            <div class="nav flex-column nav-pills purple" aria-orientation="vertical">
                <a class="nav-link" href="/galary" role="tab" aria-selected="false">Галерия</a>
                <a class="nav-link active" href="/galary/earlyPoems" aria-selected="true">Ранно творчество</a>
        ...
        <div class="row d-none d-sm-block mb-5 bg-light ">
            <ul class="nav nav-tabs col-md-12 purple">
                <li class="nav-item">
                    <a class="nav-link" href="/galary">Галерия</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/galary/earlyPoems">Ранно творчество</a>
                </li>
                <li class="nav-item">
