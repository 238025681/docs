    ...
    <div class="container bg-light">
        ...
        <div class="row d-flex mb-5 bg-light d-block d-sm-none">
            <div class="nav flex-column nav-pills" aria-orientation="vertical">
                <a class="nav-link" href="/galary" role="tab" aria-selected="false">Галерия</a>
                <a class="nav-link" href="/galary/earlyPoems" aria-selected="false">Ранно творчество</a>
                <a class="nav-link active" href="/galary/latePoems" aria-selected="true">Късно творчество</a>
        ...
        <div class="row d-none d-sm-block mb-5 bg-light ">
            ...
            <ul class="nav nav-tabs col-md-12">
                <li class="nav-item">
                    <a class="nav-link" href="/galary">Галерия</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/galary/earlyPoems">Ранно творчество</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/galary/latePoems">Късно творчество</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/galary/lastPoems" aria-selected="false">Нови</a>
                </li>
        ...
        <div class="row col-md-12 col-lg-12">
            <?php foreach ($this->latePoems as $poem) :?>
